<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('fecha_naci', $cliente->fecha_naci, ['class' => 'form-control' . ($errors->has('fecha_naci') ? ' is-invalid' : ''), 'placeholder' => 'Fecha Naci']) }}
            {!! $errors->first('fecha_naci', '<div class="invalid-feedback">:message</div>') !!}
        </div>
